...
namespace Generic.Tuples
{
    ...
    public class Tuple3<T1, T2, T3>
    {
        ...
        public Tuple3(Tuple<T1, T2> _tuple2, T3 _third)
            : this(_tuple2.Item1, _tuple2.Item2, _third)
        { }
        ...
        public override string ToString()
        {
            return string.Format("Tuple3<{0}, {1}, {2}>", Item1, Item2, Item3);
        }
    ...
    public class Tuple4<T1, T2, T3, T4>
    {
        ...
        public Tuple4(Tuple<T1, T2> _tuple2, T3 _third, T4 _fourth)
            : this(_tuple2.Item1, _tuple2.Item2, _third, _fourth)
        { }
    ...
    public class TupleI : Tuple<int, int>
    {
        ...
        {
            return new TupleI(a.Item1 + b.Item1, a.Item2 + b.Item2);
        }
        ...
        {
            return new UnityEngine.Vector2(t.Item1, t.Item2);
        }
    ...
    public class Tuple3I : Tuple3<int, int, int>
    {
        ...
        {
            return new Tuple3I(a.Item1 + b.Item1, a.Item2 + b.Item2, a.Item3 + b.Item3);
        }
        ...
        {
            return new UnityEngine.Vector3(t.Item1, t.Item2, t.Item3);
        }
